#!/usr/bin/env python3
"""Fetch concept-to-prompts daily data from SEMrush API and load into Supabase.

This endpoint provides daily data linking concepts to prompts with sentiment.
...
def fetch_day(date_str: str) -> list:
    """Fetch concept-prompts data for a single day."""
...
def main():
    ...
    print(f"Fetching concept-prompts data from {start_date.date()} to {end_date.date()}")
